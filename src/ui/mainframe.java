...
public class mainframe extends javax.swing.JFrame {
    ...
    public void tableData() {
        ...
        try {
            String sql = "SELECT id AS StudentID, sname AS Name, sage AS Age, sgrade AS Grade FROM student";
    ...
    private void initComponents() {
        ...
        jPanel4.add(agebox, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 100, 180, -1));
